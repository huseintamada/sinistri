...
class Myexcel
{
    ...
    public function generate($user, $jenis, $tahun, $kelas, $mapel, $result, $result_min = NULL, $result_max = NULL, $result_sum = NULL, $result_avg = NULL)
    {
        ...
        $object->getActiveSheet()->setCellValue('A1', 'LAPORAN DAFTAR NILAI SANTRI ' . $jenis);
        $object->getActiveSheet()->setCellValue('A2', 'Pesantren Murottal Depok');
    ...
    public function generate_siswa($user, $tahun, $kelas, $result)
    {
        ...
        $object->getProperties()->setCreator($user);
        $object->getProperties()->setLastModifiedBy($user);
        $object->getProperties()->setTitle("Data Santri Kelas $kelas Tahun $tahun");
        ...
        $object->getActiveSheet()->setCellValue('A1', 'LAPORAN DAFTAR SANTRI');
        $object->getActiveSheet()->setCellValue('A2', 'Pesantren Murottal Depok');
        $object->getActiveSheet()->setCellValue('A3', 'Tahun Ajaran ' . $tahun);
        $object->getActiveSheet()->setCellValue('A4', 'Kelas ' . $kelas);
        ...
        $object->getActiveSheet()->setCellValue('O7', 'Alamat');
        $object->getActiveSheet()->setCellValue('P7', 'KELURAHAN');
        $object->getActiveSheet()->setCellValue('Q7', 'KECAMATAN');
        $object->getActiveSheet()->setCellValue('R7', 'KABUPATEN/KOTA');
