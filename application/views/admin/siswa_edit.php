<div class="container-fluid">
    <div class="card mb-5">
        <div class="card-header">
            <i class="fas fa-user-graduate mr-3"></i>Form Tambah Data Santri
        </div>
        <div class="card-body">
            <?= form_open_multipart() ?>
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="dusun" id="dusun" placeholder="Masukan Alamat" class="form-control" value="<?php echo $siswa['dusun']; ?>">
                                <?php echo form_error('dusun', '<div class="text-danger small ml-3">', '</div>') ?>
                            </div>
                            <div class="form-group">
                                <label for="desa">Kelurahan</label>
                                <input type="text" name="desa" id="desa" placeholder="Masukan Nama Kelurahan" class="form-control" value="<?php echo $siswa['desa']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kabupaten" id="kabupaten" placeholder="Masukan Kabupaten/Kota" class="form-control" value="<?php echo $siswa['kabupaten']; ?>">
