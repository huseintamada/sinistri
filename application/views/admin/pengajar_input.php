            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="jabatan" name="jabatan">
                        ...
                        <option value="Guru Kitab Kuning">Guru Kitab Kuning</option>
                        <option value="Guru Bahasa">Guru Bahasa</option>
                        <option value="Guru Program Unggul">Guru Program Unggul</option>
                        <option value="Biro Pengasuhan">Biro Pengasuhan Santri</option>
                        <option value="Tahfidz">Guru Tahfidz</option>
                    </select>
