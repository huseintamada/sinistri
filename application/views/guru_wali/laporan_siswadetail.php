<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <a href="<?= base_url('walikelas/laporansiswa/pdf_laporan?q=detaildata&id=' . $id_siswa) ?> " class="btn btn-info mb-2"><i class="fas fa-print"></i> Print</a>
                ...
                <div class="col-sm-9">
                    ...
                    <table class="table table-borderless no-margin table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td width="300px">KABUPATEN/KOTA</td>
