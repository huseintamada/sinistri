...
<body style="background-color: white; color: black;">
    <img src="<?= base_url('assets/img/logo.jpeg') ?>" style="position: absolute; width: 110px; height: auto;">
    <table style="width: 100%;">
        <tr>
            <td align="center">
                <span style="line-height: 1.6; font-weight: bold; font-size: 28px; color: black;">PESANTREN MUROTTAL DEPOK</span>
                <br>Alamat: Jl. Panggulan No.18, Pengasinan, Kec. Sawangan, Kota Depok, Jawa Barat 16518
                <br>Telepon : 0878-7603-4933
                <br>E-mail : pesantrenmurottaldpk@gmail.com
            </td>
        </tr>
    </table>
