        ...
        <ul class="c-sidebar-nav">
            ...
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link <?php if ($menu == 'siswa') echo 'c-active' ?>" href="<?= base_url('admin/siswa') ?>"> Santri</a></li>
            ...
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link <?php if ($menu == 'laporan_siswa') echo 'c-active' ?>" href="<?= base_url('admin/laporansiswa') ?>"> Laporan Daftar Santri</a></li>
    ...
    <div class="c-wrapper c-fixed-components">
        <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
            ...
            <ul class="c-header-nav d-md-down-none">
                <li class="c-header-nav-item px-3">Sistem Informasi Penilaian Santri</li>
            </ul>
