        ...
        <div class="forms-container">
            <div class="signin">
                <form method="post" action="" class="sign-in-form">
                    <img src="<?php echo base_url() ?>assets/img/logo.png" alt="" class="image-logo">
                    ...
                    <div class="input-field">
                        ...
                        <input type="password" placeholder="Password (DDMMYYYY)" id="password" name="password" />
                    </div>
